...
- Experimenting with new tech & simplifying complex ideas  
...
A real-time aquaculture monitoring platform with sensor-based analytics and visualization.  
**Stack:** Node.js • React • WebSockets/MQTT • MongoDB • Nginx HTTPS  

---

### 💊 [MediTrack Pharmacy SaaS](https://meditrack-v1.vercel.app)  
SaaS platform for pharmacies with inventory, sales, and analytics dashboards.  
**Stack:** MERN Stack • JWT Auth • Cloud APIs • Role-based Access  

---

### ⚖️ [Lex.AI Legal Assistant](#)  
AI chatbot providing legal guidance and workflow automation for professionals.  
**Role:** Co-Founder — focused on backend APIs and conversational intelligence.  
...
## 🧩 Highlights
- Developed full-stack applications combining performance and scalability  
- Built real-time dashboards with modern data visualization  
- **CTO at Xfishery** — leading technical strategy & data architecture  
- **Co-Founder at Lex.AI** — developing intelligent automation flows  
- Curious and eager to experiment with new technologies  

---

## 💬 Philosophy
> “Technology isn’t just about code — it’s about curiosity, creativity, and the drive to build what doesn’t exist yet.”  
> – Shahriar Hossain  
